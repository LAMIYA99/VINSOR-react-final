  ...
  <div className="container mx-auto px-31 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
    ...
    <div>
      ...
      <p className="text-[#4A4A4A] mt-6 leading-7">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla eu turpis
        et quam auctor bibendum etivitale arcu. Etiam mollis leoiat lorem
        placerat aliquet nisi aliquam praesent mauris.
      </p>
    ...
    <div>
      ...
      <div className="w-full h-[380px] bg-gray-300 rounded"></div>
    </div>
  </div>
</section>
  )
